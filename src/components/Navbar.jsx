...
function Navbar() {
  ...
  return (
    <div className="container-nav md:mt-6 bg-mirage py-[1.125rem] flex justify-between items-center md:rounded-lg lg:mt-8  lg:max-h-[960px] lg:h-[83vh] lg:w-[96px] lg:flex-col lg:justify-start lg:rounded-[20px] lg:pt-[2.4rem] lg:pb-8">
      <NavLink to="/home">
